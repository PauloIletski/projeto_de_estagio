    ...
    success: function (datas, response, jqXHR) {
      ...
      for (var i = 0; $resposta.length > i; i++) {
        $("#corpoTbRetorno").append(
          ...
          "</td><td>" +
          $resposta[i].lote_producao +
          "</td><td>" +
          $resposta[i].data_inicio_producao +
          "</td><td>" +
          $resposta[i].data_fim_producao +
          "</td><td>" +
          $resposta[i].qtd_produzida +
          "</td><td>" +
          $resposta[i].qtd_rejeitada +
          "</td><td>" +
          $resposta[i].acao +
          "</td><td>" +
          $resposta[i].usuario +
